...
class WeeksMenuPage extends StatefulWidget {
  ...
  const WeeksMenuPage({super.key, required this.allDishes});
...
class _WeeksMenuPageState extends State<WeeksMenuPage> {
  ...
  Future<void> _selectDish(BuildContext context, String day) async {
    final allDishes = widget.allDishes;
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: kCategoryColors[dish.category]?.withOpacity(0.5),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        if (dish != null) {
          final selectedDish = widget.allDishes.firstWhere(
            (d) => d.name == dish,
...
// Expose the state type for external access
typedef WeeksMenuPageState = _WeeksMenuPageState;
